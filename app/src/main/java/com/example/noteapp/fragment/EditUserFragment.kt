...
class EditUserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val imgAvatar = view.findViewById<ImageView>(R.id.edt_user_avatar)
        val tvName = view.findViewById<TextView>(R.id.edt_user_name)
        val tvEmail = view.findViewById<TextView>(R.id.edt_user_mail)
        val tvPhone = view.findViewById<TextView>(R.id.edit_user_phone)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val edtName = view.findViewById<TextView>(R.id.edt_user_name)
